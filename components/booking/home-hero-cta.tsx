  ...
  return (
    <div className="pointer-events-auto flex flex-col gap-3 w-full max-w-[340px] lg:max-w-[360px] mx-auto lg:mx-0 mt-2">
      <button
        type="button"
        onClick={() => openBooking()}
        className="bg-[#E5D8CD] lg:bg-black hover:bg-[#DBCFBF] lg:hover:bg-zinc-800 text-[#2d241e] lg:text-white font-sans text-xs font-semibold uppercase tracking-[0.22em] py-4 px-6 rounded-none transition-colors duration-200 w-full text-center shadow-sm cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#E5D8CD] lg:focus-visible:outline-black"
      >
